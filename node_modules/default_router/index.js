...
defaultHandlers.request['GET'].push(
	{
		...
		callback : function(request, response){
			var ret = cache.getUncached('./' + configuration['baseFolder'] + request.params[0]);
			if(ret.failed){
				...
				response.writeHead(200, {"Content-Type": mime.lookup(request.params[0])});
...
defaultHandlers.request['GET'].push(
	{
		...
		callback : function(request, response){
			var ret = cache.getUncached('./' + configuration['baseFolder'] + 'index.html');
			if(ret.failed){
				response.writeHead(404, {"Content-Type": "text/html"});
